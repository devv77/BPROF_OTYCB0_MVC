...
namespace ApiApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DriversDbContext>();
            services.AddIdentity<IdentityUser, IdentityRole>(
                ...
                }).AddEntityFrameworkStores<DriversDbContext>().AddDefaultTokenProviders();

            //Csak regisztrált user tud küldeni put kérést Middleware
